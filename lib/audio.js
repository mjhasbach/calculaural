        ...
        notes: {
            ...
            generate: function(instrumentCursor) {
                let notes = [],
                    ...
                    {tone, tonic, chordType, arpeggiateChord, arpeggioDirection, arpeggioPeakValley} = instrumentOpts,
                    scale = tonic === 'none' ? null : teoria.scale(tonic, instrumentOpts.scale),
                    transpose = {
                ...
                if (!tone || voices !== tone.voices.length) {
                    ...
                    instrumentCursor.set('tone', new Tone.PolySynth(voices).toMaster().set(instrumentOpts));
                }
